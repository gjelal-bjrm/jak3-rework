...
def main():
    ...
    export=HERE/(a.level+'-native.json');source=read(export);reset()
    ...
    report={'level':a.level,'source_export':str(export),'source_export_sha256':sha(export),'source_fr3':source['source_fr3'],
            'author_sha256':sha(__file__),'instances':[],'scope':'Rounded plaster construction edges and continuous thick weathered roof coping; native shapes, UV palette and doors retained',
