"""Install the reviewed ornament revision without changing its immutable parent."""
...
def main():
    ...
    record = H.parent/'architecture/revision-001/installed.json'
    ...
    print('Installed ornament revision:', sha(live))
