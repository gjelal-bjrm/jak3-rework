...
def main():
 ...
 parent=R/'city-remaster/environment/geometry-002/wascitya-installed.json';prec=read(parent)
 ...
 manifest={'status':'staged','path':'out/jak3/fr3/wascitya.fr3','base_path':str(before),'base_sha256':sha(before),
  ...
  'native_visual_validation':False,'scope':'Two WCA house envelopes, five true window apertures, reveals, balconies, differentiated roof volumes; interiors separate'}
